...
for File_path = 1%:3
    ...
    PARAMETER_MAIN_name = append(path_name,'\PARAMETER_MAIN_M_1.5_N_1.5_C_15_CLASS02.mat');
    PARAMETER_FUNCTION_name = append(path_name,'\PARAMETER_FUCNTION_M_1.5_N_1.5_C_15_CLASS02.mat');
    ...
    for RESUM_ROW_m = ROW_m:size(PARAMETER_m,1)
        for RESUM_ROW_n = ROW_n:size(PARAMETER_n,1)
            for RESUM_ROW_c02 = ROW_c02:size(PARAMETER_c,1)
                c02 = PARAMETER_c(RESUM_ROW_c02);
                ...
                create_PARAMETER_MAIN = append(create_path,'\PARAMETER_MAIN_M_',num2str(PARAMETER_m(RESUM_ROW_m)),'_N_',num2str(PARAMETER_n(RESUM_ROW_n)),'_C_',num2str(PARAMETER_c(RESUM_ROW_c02)),'_CLASS02.mat');
                PARAMETER_MAIN = {RESUM_ROW_m,RESUM_ROW_n,RESUM_ROW_c02};
                ...
                if PARAMETER_i == 0
                    if use_init_V
                        ...
                        V = F03_sgPFCMed_InitV (X,c02); % Initial cluster centers
                    end
                end
                ...
                create_PARAMETER_FUCNTION = append(create_path,'\PARAMETER_FUCNTION_M_',num2str(options(1)),'_N_',num2str(options(2)),'_C_',num2str(PARAMETER_c(RESUM_ROW_c02)),'_CLASS02.mat');
                
                E_old = 0;
                E_COUNT = 0;
                
                for i = PARAMETER_i+1:max_iter
                    [V, U, T, E(i)] = F04_sgPFCMed_Step(X, V, c02, m, eta,a,b,G);
                    ...
                    PARAMETER_FUCNTION = {i,V,U,T,E,X,c02,E_old,E_COUNT};
                ...
                GRID_SEARCH_MNC_CLASS02{1,1} = V;
                GRID_SEARCH_MNC_CLASS02{2,1} = U;
                GRID_SEARCH_MNC_CLASS02{3,1} = T;
                GRID_SEARCH_MNC_CLASS02{4,1} = E;
                
                create_GRID_SEARCH_MNC_CLASS02 = append(create_path,'\PROTOTYPE_M_',num2str(PARAMETER_m(RESUM_ROW_m)),'_N_',num2str(PARAMETER_n(RESUM_ROW_n)),'_C_',num2str(PARAMETER_c(RESUM_ROW_c02)),'_CLASS02.mat');
