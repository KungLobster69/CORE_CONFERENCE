...
for File_path = 1%:3
    ...
    path_PROTOTYPE_name = append('D:\KUNG_LOBSTER69\RESULT\SEED_IV\METHOD01\09.GRID_SEARCH\GRID_SEARCH_MN\',num2str(File_path));
    CLASS00_name = append(path_PROTOTYPE_name,'\PROTOTYPE_M_1.5_N_1.5_CLASS00.mat');
    CLASS01_name = append(path_PROTOTYPE_name,'\PROTOTYPE_M_1.5_N_1.5_CLASS01.mat');
    CLASS02_name = append(path_PROTOTYPE_name,'\PROTOTYPE_M_1.5_N_1.5_CLASS02.mat');
    CLASS03_name = append(path_PROTOTYPE_name,'\PROTOTYPE_M_1.5_N_1.5_CLASS03.mat');
    ...
    DATA_CLASS00 = DATA_CLASS00_load.GRID_SEARCH_MN_CLASS00;
    DATA_CLASS01 = DATA_CLASS01_load.GRID_SEARCH_MN_CLASS01;
    DATA_CLASS02 = DATA_CLASS02_load.GRID_SEARCH_MN_CLASS02;
    DATA_CLASS03 = DATA_CLASS03_load.GRID_SEARCH_MN_CLASS03;
    ...
    create_TEST_RESULT = append(create_path,'\TEST_EDIT_DISTANCE_MN.mat');
    mkdir(create_path)
