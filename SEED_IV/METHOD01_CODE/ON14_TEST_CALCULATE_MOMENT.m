...
for File_path = 1:3
    % CALCULATE_MOMENT
    path_name = append('D:\KUNG_LOBSTER69\RESULT\SEED_IV\METHOD01\12.TEST_Wavelet_LV3_DATA\',num2str(File_path));
    ...
    %% SAVE_DATA
    create_path = append('D:\KUNG_LOBSTER69\RESULT\SEED_IV\METHOD01\14.TEST_CALCULATE_MOMENT\',num2str(File_path));
