...
for File_path = 1:3
    path_name = append('D:\KUNG_LOBSTER69\RESULT\SEED_IV\METHOD01\15.TEST_CLUSTERING_52GROUP\',num2str(File_path));
    ...
    for HUMAN = 1:2
        ...
        %% SAVE_DATA
        create_path = append('D:\KUNG_LOBSTER69\RESULT\SEED_IV\METHOD01\16.TEST_SORT_BY_VDO\',num2str(File_path));
