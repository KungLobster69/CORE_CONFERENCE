function [V, U, T, E] = sgpfcmed (X, c, options, init_V)
%
...
for i = 1:max_iter,
    ...
    Parameter = [X, V, c, m, eta,a,b,G,i,E_COUNT,E_old];
    create_path_sgPFCMed = append('D:\KUNG_LOBSTER69\SEED_IV_METHOD\METHOD5.2_FILE\PARAMETER\PARAMETER.mat');
end
