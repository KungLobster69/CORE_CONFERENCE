...
for File_path = 1:3
    path_name = append('D:\KUNG_LOBSTER69\RESULT\SEED_IV\METHOD01\16.TEST_SORT_BY_VDO\',num2str(File_path));
    ...
    for VDO = 1:48
        ...
        %% SAVE_DATA
        create_path = append('D:\KUNG_LOBSTER69\RESULT\SEED_IV\METHOD01\17.TEST_CONVERT2STR\',num2str(File_path));
