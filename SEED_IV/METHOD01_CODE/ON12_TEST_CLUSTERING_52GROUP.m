...
for File_path = 1:3
    path_TRAIN_TRAIN_CENTER_name = append('E:\THESIS\RESULT\SEED_IV\METHOD01\05.CLUSTERING_52GROUP\',num2str(File_path),'\TRAIN_TRAIN_CENTER.mat');
    path_TEST_MOMENT_DATA_name = append('E:\THESIS\RESULT\SEED_IV\METHOD01\11.TEST_CALCULATE_MOMENT\',num2str(File_path),'\TEST_MOMENT_DATA.mat');
    ...
    %% SAVE_DATA
    create_path = append('E:\THESIS\RESULT\SEED_IV\METHOD01\12.TEST_CLUSTERING_52GROUP\',num2str(File_path));
