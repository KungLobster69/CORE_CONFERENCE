...
for File_path = 1:3
    ...
    for COL_K = 1:size(k,2)
        ...
        CLUSTERING_CHARACTER_name = append(path_name,'\CHARACTER_VDO_LV3_100_',num2str(k(COL_K)),'.mat');
        ...
        create_TRAIN_STR = append(create_path,'\TRAIN_STR_LV3_100_',num2str(k(COL_K)),'.mat');
        mkdir(create_path)
