...
for File_path = 1:3
    path_name = append('E:\THESIS\RESULT\SEED_IV_CONFERENCE\METHOD01\03.TRAIN_AND_TEST_DATA\',num2str(File_path));
    ...
    % SAVE_DATA
    create_path = append('E:\THESIS\RESULT\SEED_IV_CONFERENCE\METHOD01\04.WAVELET_LV\',num2str(File_path));
