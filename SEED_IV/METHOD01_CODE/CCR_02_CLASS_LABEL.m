...
for File_path = 1:3
    path_name = append('E:\THESIS\RESULT\SEED_IV_CONFERENCE\METHOD01\01.DATA_VDO\',num2str(File_path));
    ...
    % SAVE_DATA
    create_path = append('E:\THESIS\RESULT\SEED_IV_CONFERENCE\METHOD01\02.CLASS_LABEL\',num2str(File_path));
