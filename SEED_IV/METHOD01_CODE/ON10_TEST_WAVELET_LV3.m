...
for File_path = 1:3
    path_name = append('E:\THESIS\RESULT\SEED_IV\METHOD01\09.TEST_DATA_SORT_VDO_BY_CLASS\',num2str(File_path));
    ...
    %% SAVE_DATA
    create_path = append('E:\THESIS\RESULT\SEED_IV\METHOD01\10.TEST_Wavelet_LV3_DATA\',num2str(File_path));
