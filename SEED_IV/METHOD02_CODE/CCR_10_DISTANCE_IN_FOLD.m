...
for COL_K = 1:size(k,2)
    ...
    for Order_K_FOLD = 1:K_FOLD
        TRAIN_TRAIN_name = append(path_name,'\TRAIN_TRAIN_LV3_500_',num2str(k(COL_K)),'_',num2str(Order_K_FOLD),'.mat');
        TRAIN_TEST_name = append(path_name,'\TRAIN_TEST_LV3_500_',num2str(k(COL_K)),'_',num2str(Order_K_FOLD),'.mat');
        ...
        % SAVE_DATA %
        create_path = append('D:\KUNG_LOBSTER69\RESULT\SEED_IV_CONFERENCE\METHOD02\10.DISTANCE_FOLD');
        create_DISTANCE = append(create_path,'\DISTANCE_FOLD_LV3_500_',num2str(k(COL_K)),'_',num2str(Order_K_FOLD),'.mat');
        mkdir(create_path)
