...
for File_path = 1:3
    path_name = append('D:\KUNG_LOBSTER69\RESULT\SEED_IV_CONFERENCE\METHOD02\01.DATA_VDO\',num2str(File_path));
    ...
    % SAVE_DATA
    create_path = append('D:\KUNG_LOBSTER69\RESULT\SEED_IV_CONFERENCE\METHOD02\02.CLASS_LABEL\',num2str(File_path));
